...
function of the \lstinline{UVar} class.
...
to the \lstinline{UVar}. To have more control on the bandwidth used, you can
...
You can read and write all the \urbi properties of an \lstinline{UVar} by
