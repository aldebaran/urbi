...
Nevertheless, \urbi SDK provides two tools to compile UObject seamlessly.
...
\urbi SDK package, see \autoref{sec:install:install}.
...
If you installed \urbi SDK using its installer, and if you had Visual \Cxx
