...
\item \lstinline|slotNames|\\
  Deprecated in favor of \lstinline|localSlotNames| and
  \lstinline|allSlotNames|.  Currently return the list of the names of
  the slots owned by \lstinline|this|, but will eventually return the
  list of all the slot names.
