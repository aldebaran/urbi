...
\item \lstinline|criticalSection(function () {\var{code}})|
  ...
  \lstinline|p| and a call to \lstinline|v| when the code ends by any means.
...
\item[p] Wait to enter a critical section delimited by the execution of
  \lstinline|p| and \lstinline|v|.  Enter the critical section when the
  number of processes inside it goes below the maximum allowed.

\item[v] Leave a cirtical section delimited by the execution of
