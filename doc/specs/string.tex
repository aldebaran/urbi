...
syntax.  Several escaping sequences (the traditional ones and \us
specific ones) allow to insert special characters.  Consecutive
string literals are merged together.  See
\autoref{sec:us-syn-lit-string} for details and examples.
...
\item \lstinline|'%'(\var{args})|\\
  It is an equivalent of \lstinline|Formater.new(this) % \var{args}|
