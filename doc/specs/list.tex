...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'\[\]'|},
%label=lst:list-nth]
\begin{urbiscript}[firstnumber=last]
var l = [0, 1, 2];
[00000000:hide] [0, 1, 2]
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.==|}, label=lst:list-sameAs]
\begin{urbiscript}[firstnumber=last]
[0, 1, 2] == [0, 1, 2];
[00000000] true
[0, 1, 2] == [0, 0, 2];
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'\[\]='|}, label=lst:list-setNth]
\begin{urbiscript}[firstnumber=last]
var f = [0, 1, 2];
[00000000] [0, 1, 2]
f[1] = 42;
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'*'|}, label=lst:list-times]
\begin{urbiscript}[firstnumber=last]
[0, 1] * 3;
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'+'|}, label=lst:list-plus,
\begin{urbiscript}[firstnumber=last]
[0, 1] + [2, 3];
[00000000] [0, 1, 2, 3]
\end{urbiscript}
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'-'|}, label=lst:list-minus,
\begin{urbiscript}[firstnumber=last]
[0, 1, 0, 2, 3] - [1, 2];
[00000000] [0, 0, 3]
\end{urbiscript}
...
%\begin{urbiscript}[firstnumber=last][caption={\lstinline|List.'<'|}, label=lst:list-inf,
\begin{urbiscript}[firstnumber=last]
[0, 1, 2] < [0, 1, 2];
[00000000] false
[0, 1, 2] < [0, 0, 2];
