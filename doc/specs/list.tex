...
\begin{urbiscript}[caption=List.nth, label=lst:list-nth]
[0, 1, 2].nth(1);
[00000000] 1
[0, 1, 2].nth(3);
...
\begin{urbiscript}[caption=List.pop\_back, label=lst:list-popback]
var x = [0, 1, 2];
[00000000] [0, 1, 2]
x.pop_back;
[00000000] 2
...
\begin{urbiscript}[caption=List.pop\_front, label=lst:list-popfront]
var x = [0, 1, 2];
[00000000] [0, 1, 2]
x.pop_front;
[00000000] 0
...
\begin{urbiscript}[caption=List.push\_back, label=lst:list-pushback]
var x = [0, 1];
[00000000] [0, 1]
x.push_back(2);
[00000000] [0, 1, 2]
...
\begin{urbiscript}[caption=List.push\_front, label=lst:list-pushfront]
var x = [1, 2];
[00000000] [1, 2]
x.push_front(0);
[00000000] [0, 1, 2]
...
\begin{urbiscript}[caption=List.setNth, label=lst:list-setNth]
var x = [0, 1, 2];
[00000000] [0, 1, 2]
x.setNth(1, 42);
[00000000] 42
