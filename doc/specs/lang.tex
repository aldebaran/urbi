...
\newcommand{\operatorhead}{
  \strong{\ifx\ifHtml\undefined{Oper.}\else{Operator}\fi}
  & \strong{Syntax}
  & \strong{\ifx\ifHtml\undefined{Assoc.}\else{Associativity}\fi}
  & \strong{Semantics}
  & \strong{Equivalence}
  \\
}
...
\begin{operatorTable}{tab:operators-summary}{Miscellaneous operators}
  \operatordot
  \operatordota
  \hline
  \operatorprop
...
\begin{operatorTable}{sec:us-fun-callmsg}{Operators summary}
  \operatordot
  \operatordota
  \hline
  \operatorprop
