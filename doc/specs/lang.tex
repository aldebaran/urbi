...
expression (see \autoref{lst:identifiers}).  Additionally, identifiers
must not match any of the \us reserved words\footnote{
%%
...
(\lstinline|[]|), as shown in \autoref{lst:literal-lists}.  See
...
\begin{urbiscript}[caption=Assignment operators, label=lst:assignment-operators]
var x = 0;
[00000000] 0
x = 10;
[00000000] 10
...
\begin{urbiscript}[caption=Bitwise operators, label=lst:bitwise-operators]
4 << 2;
[00000000] 16
4 >> 2;
[00000000] 1
...
\begin{urbiscript}[caption=Comparison operators, label=lst:comparison-operators]
0 < 0;
[00000000] false
0 <= 0;
[00000000] true
...
shown in \autoref{lst:do}.  The whole construct evaluates to the value
of \var{body}.
...
is accessible via the \var{name} local variable. \autoref{lst:foreach}
illustrates this.
