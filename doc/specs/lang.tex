...
Currently \us makes no asumptions about the encoding used in the
...
separators (see \autoref{sec:lang:separators}). The last separator is
...
\subsection{Scoping at \lstinline'at'}
...
% LocalWords:  Synclines zA eq asm loopn namespace bitand bitor bool onleave mn
% LocalWords:  compl const sizeof stopif struct enum extern typedef typeid goto
% LocalWords:  typename foreach freezeif waituntil wchar inline fA xfF baz nb
% LocalWords:  foobarbaz urbiScript desugared stdlib redefinable args Bitwise
% LocalWords:  updateSlot bitwise variadic abcdef bc afoodef isVoid subscopes
% LocalWords:  arg CallMessage evalArgAt createSlot getSlot setSlot asString sw
% LocalWords:  localSlotNames protos addProto removeProto lookup prepended p's
% LocalWords:  msg sqrt sqr Frodo iterable cond exn
