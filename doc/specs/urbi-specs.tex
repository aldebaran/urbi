...
\lstinline|target|, as shown in \lst{do}.  The \lstinline|do| itself
...
is accessible via the \lstinline|name| local variable. \lst{foreach}
illustrates this.
...
void if no match was found and there's no default case. \lst{switch}
...
jumps after the \lstinline|while|. See \lst{while}.
