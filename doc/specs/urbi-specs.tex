...
\newcommand   {\floatpos}          {htbp}
\newcommand   {\flushfloat}        {\afterpage{\clearpage}}
\setcounter   {topnumber}          {3} % Enable up to two float at the top of pages
\setcounter   {bottomnumber}       {2} % Enable up to two float at the bottom of pages
\renewcommand {\floatpagefraction} {0.8}
...
\begin{lstlisting}[caption=Arithmetic operators,
  label=lst:arithmetic-operators,float=\floatpos]
  1 + 1;
  [00000000] 2
  1 - 2;
  [00000000] -1
...
\begin{lstlisting}[caption=Assignment operators,
  label=lst:assignment-operators,float=\floatpos]
  var x = 0;
  [00000000] 0
  x = 10;
  [00000000] 10
...
\begin{lstlisting}[caption=Bitwise operators,
  label=lst:bitwise-operators,float=\floatpos]
  4 << 2;
  [00000000] 16
  4 >> 2;
  [00000000] 1
...
\begin{lstlisting}[caption=Logic operators,
  label=lst:logic-operators,float=\floatpos]
  true && true;
  [00000000] true
  true || false;
  [00000000] true
...
\begin{lstlisting}[caption=Comparison operators,
  label=lst:comparison-operators,float=\floatpos]
  0 < 0;
  [00000000] false
  0 <= 0;
  [00000000] true
...
\begin{lstlisting}[caption=Miscellaneous operators,
  label=lst:miscellaneous-operators,float=\floatpos]
  0 < 0;
  [00000000] false
  0 <= 0;
  [00000000] true
