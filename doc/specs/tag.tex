...
to control them externally.  Tagged code can be frozen, resumed,
...
\item[enter]
  An event that trigger each time flow control enter the tagged code.
...
\item[leave]
  An event that trigger each time flow control leaves the tagged code.
  See \autoref{sec:specs:tag:enter-leave}.
