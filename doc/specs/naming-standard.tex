...
on the class of the robot (wheeled, humanoid, animaloid, etc.).
The following sections provide some guidelines for the most common
designations, and more advanced rules for rare customized
cases.
...
with simple geometric qualifiers like
\textit{Right}/\textit{Center}/\textit{Left},
\textit{Front}/\textit{Middle}/\textit{Back} or
\textit{Up}/\textit{In-between}/\textit{Down}. The naming
