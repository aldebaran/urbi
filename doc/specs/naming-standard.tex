...
\begin{supertabular}{|m{2.312cm}|m{6.776cm}|m{2.629cm}|m{2.471cm}|m{2.1269999cm}|}
  \component{robot}{\code{{}-} }{\code{body} }{\ttfamily identity
    network mobile tracker}{
    %%
  ...
  \component{body}{\code{robot} }{\ttfamily arm leg neck head wheel tail skin
torso … }{\code{{}-} }{
    %%
...
the body.
  ...
  \component{leg}{\code{body} }{hip knee ankle foot joint }{\code{{}-} }{
    %%
...
joints.
  ...
  \component{arm}{\code{body} }{shoulder elbow wrist hand grip  joint }{\code{{}-} }{
    %%
...
like a leg, it will be considered as an arm.
  ...
  \component{shoulder}{\code{arm} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
closest part of the arm relative to the body.
  ...
  \component{elbow}{\code{arm} }{\code{pitch} }{\code{{}-} }{
    %%
...
arm, this is usually a single rotational axis.
  ...
  \component{wrist}{\code{arm} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
of the arm. Usually three degrees of freedom axis.
  ...
  \component{hand}{\code{arm} }{\code{finger} }{\code{{}-} }{
    %%
...
and between the arm and the hand.
  ...
  \component{finger}{\code{hand} }{\code{touch} }{\code{motor} }{
    %%
...
the hand.
  ...
  \component{grip}{\code{arm hand} }{\code{touch} }{\code{motor} }{
    %%
      Simple two-fingers system.
    %%
    }

  \component{hip}{\code{leg} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
of freedom.
  ...
  \component{knee}{\code{leg} }{\code{pitch} }{\code{{}-} }{
    %%
...
leg, this is usually a single rotational axis.
  ...
  \component{ankle}{\code{leg} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
of the leg. Usually three degrees of freedom axis.
  ...
  \component{foot}{\code{leg} }{\code{touch} }{\code{{}-} }{
    %%
...
in simple configurations.
  ...
  \component{toe}{\code{foot} }{\code{touch} }{\code{motor} }{
    %%
...
foot.
  ...
  \component{neck}{\code{body} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
between the head and the main body.
  ...
  \component{tail}{\code{body} }{\code{joint} }{\code{{}-} }{
    %%
...
motors at the back of the robot.
  ...
  \component{head}{\code{body neck} }{\code{camera mouth ear lip eye eyebrow} }{\code{{}-} }{
    %%
      The head main pivotal axis.
    %%
    }

  \component{mouth}{\code{head} }{\code{lip} }{\code{motor} }{
    %%
      The robot mouth (open/close)
    %%
    }

  \component{ear}{\code{head} }{\code{{}-} }{\code{motor} }{
    %%
...
certain robots.
  ...
  \component{joint}{\code{tail arm leg lip} }{\code{{}-} }{\code{motor} }{
    %%
      Generic articulation in the robot.
    %%
    }

  \component{yaw}{\ttfamily neck knee ankle shoulder elbow wrist
torso }{\code{{}-} }{\code{rotational-Motor} }{
    %%
...
direction corresponds to yaw.}
  ...
  \component{pitch}{\ttfamily neck knee ankle shoulder elbow wrist
torso }{\code{{}-} }{\code{rotational-Motor} }{
    %%
...
direction corresponds to pitch.}
  ...
  \component{roll}{\ttfamily neck knee ankle shoulder elbow wrist
torso }{\code{{}-} }{\code{rotational-Motor} }{
    %%
...
direction corresponds to roll.}
  ...
  \component{lip}{\code{mouth} }{\code{joint} }{\code{motor} }{
    %%
      Corresponds to animated lips.
    %%
    }

  \component{eye}{\code{head} }{\code{camera} }{\code{{}-} }{
    %%
...
axis.
  ...
  \component{eyebrow}{\code{head} }{\code{joint} }{\code{motor} }{
    %%
...
generally one or several degree of freedom.
  ...
  \component{torso}{\code{body} }{\code{yaw pitch roll} }{\code{{}-} }{
    %%
...
rotational axis in the middle of the main body.
  ...
  \component{spine}{\code{torso} }{\code{joint} }{\code{{}-} }{
    %%
...
freedom in the back of the robot.
  ...
  \component{clavicle}{\code{body} }{\code{{}-} }{\code{motor} }{
    %%
...
raising” movement.
  ...
  \component{touch}{\code{finger grip foot toe} }{\code{{}-} }{\code{touchSensor} }{
    %%
      Touch sensor.
    %%
    }

  \component{gyro}{\code{body} }{\code{{}-} }{\code{gyroSensor} }{
    %%
      Gyrometer sensor.
    %%
    }

  \component{accel}{\code{body} }{\code{{}-} }{\code{accelerationSensor} }{
    %%
      Accelerometer sensor.
    %%
    }

  \component{camera}{\code{head body} }{\code{{}-} }{\code{videoin} }{
    %%
...
\texttt{cameraR} or \texttt{cameraL}).
  ...
  \component{speaker}{\code{head body} }{\code{{}-} }{\code{audioin} }{
    %%
...
\texttt{speakerR} or \texttt{speakerL}).
  ...
  \component{micro}{\code{head body} }{\code{{}-} }{\code{audioout} }{
    %%
...
microphones (like \texttt{microR} or \texttt{microL}).
  ...
  \component{speech}{\code{robot} }{\code{{}-} }{\code{speechRecognizer} }{
    %%
      Speech recognition component.
    %%
    }

  \component{voice}{\code{robot} }{\code{{}-} }{\code{textToSpeech} }{
    %%
