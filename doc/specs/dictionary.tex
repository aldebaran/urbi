...
The output generated for dictionary can also be used to create a
...
\item \lstinline|matchAgainst(\var{handler}, \var{pattern})|\\
  This method enable pattern matching of members of Dictionary.  See
  \refObject{Pattern}.
...
\item \lstinline|'=='(\var{that})|\\
  Whether \lstinline|this| equals \var{that}.  This suppose that elements
