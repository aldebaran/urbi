...
%% FIXME: \item[limit_digits]
%% FIXME:   Number of digits (in \lstinline|Float.limit_radix| base) in the
%% FIXME:   mantissa.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.limit_digits;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_digits10]
%% FIXME:   Number of digits (in decimal base) that can be represented without
%% FIXME:   change.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.limit_digits10;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_epsilon]
%% FIXME:   Machine epsilon (the difference between 1 and the least value
%% FIXME:   greater than 1 that is representable).
%% FIXME: \begin{urbiassert}
%% FIXME: 1 != 1 + Float.limit_epsilon;
%% FIXME: 1 == 1 + Float.limit_epsilon / 2;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_max]
%% FIXME:   Maximum finite value.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.limit_max     != Float.inf;
%% FIXME: Float.limit_max * 2 == Float.inf;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_max_exponent]
%% FIXME:   Maximum integer value for the exponent that generates a normalized
%% FIXME:   floating-point number.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.inf != Float.limit_radix ** (Float.limit_max_exponent - 1);
%% FIXME: Float.inf == Float.limit_radix ** Float.limit_max_exponent;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_max_exponent10]
%% FIXME:   Maximum integer value such that 10 raised to that power generates a
%% FIXME:   normalized finite floating-point number.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.inf != 10 ** Float.limit_max_exponent10;
%% FIXME: Float.inf == 10 ** (Float.limit_max_exponent10 + 1);
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_min]
%% FIXME:   Minimum positive normalized value.
%% FIXME: \begin{urbiassert}
%% FIXME: 0 != Float.limit_min;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_min_exponent]
%% FIXME:   Minimum negative integer value for the exponent that generates a
%% FIXME:   normalized floating-point number.
%% FIXME: \begin{urbiassert}
%% FIXME: 0 != Float.limit_radix ** Float.limit_min_exponent;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_min_exponent10]
%% FIXME:   Minimum negative integer value such that 10 raised to that power
%% FIXME:   generates a normalized floating-point number.
%% FIXME: \begin{urbiassert}
%% FIXME: 0 != 10 ** Float.limit_min_exponent10;
%% FIXME: \end{urbiassert}
%% FIXME:
%% FIXME: \item[limit_radix]
%% FIXME:   Base of the exponent of the representation.
%% FIXME: \begin{urbiassert}
%% FIXME: Float.limit_radix == 2;
%% FIXME: \end{urbiassert}
