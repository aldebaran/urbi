...
\item Add a line containing
  %%
  \lstinline|LaunchThread("ALUrbiStarter", "runServer", [ ]);|
  %%
  to \file{/opt/naoqi/bin/naoqi-autolaunch}.
...
\var{Object.getPeriod} variable. The default is 10ms which is the native period
of \naoqi.
...
write all sent commands to the file /tmp/traj.log. Each line will
...
\item \lstinline|formatDetail| \\
  ...
  \item \lstinline|6| Grey8: grey image, 1 byte/pixel.
  \item \lstinline|7| Grey4: grey image 4 bits/pixel.
  \end{itemize}
