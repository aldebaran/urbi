...
In order to run \uwebots unlimitedly you must provide it with a
licence file, as described in the following section.

\subsubsection{Setting up a license}
\newcommand{\webotskey}{\file{webots.key}\xspace}
\newcommand{\urbikey}{\file{urbi.key}\xspace}
\newcommand{\webotskeydir}{\file{webots/ressources/}\xspace}
...
you instanciate both left and right objects.
