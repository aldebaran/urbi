...
\subsubsection{Urbi licensing with a \webotskey \webots license}

To get an \urbi license using this type of licensing, please send us a
copy of your \webotskey license, we will generate the \urbi
license using this file.

Once you have your \file{urbi.key} file, put the \webotskey
file in the folder \file{webots/ressources/} (warning: it is mandatory
to have a copy of the \webotskey in this folder, if you don't have it,
\urbi won't find the \webotskey file and you will get a
...
\subsubsection{Urbi licensing with USB dongle \webots license}
