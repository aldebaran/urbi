...
\begin{itemize}
\item \refSlot{Global}{Tags} is renamed as \refSlot{Tag}{tags}.

\item \refSlot{Global}{Task} is renamed as \refSlot{Global}{Job}.

\item \refSlot{Global}{topLevel} is renamed as \refSlot{Channel}{topLevel}.

\item \refSlot{Global}{output}, \refSlot{Global}{error} are removed, they
  were deprecated in favor of \refSlot{Global}{cout} and
  \refSlot{Global}{cerr}.
...
\subsubsection{Changes}
\begin{itemize}
\item \refSlot{Lobby}{quit} replaces \refSlot{System}{quit}.
