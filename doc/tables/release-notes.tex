...
\subsubsection{New objects}
\begin{itemize}
\item \refObject{Component}, \refObject{Localizer}, \refObject{Facet}:
...
\item \refObject{WeakDictionary}, \refObject{WeakPointer}: Store
...
\item environment variables
  \env{URBI\_UOBJECT\_PATH}, \env{URBI\_PATH}, \env{URBI\_ROOT}.
\item special files
  \file{global.u}, \file{local.u}.
\item k1-to-k2
...
%% FIXME: base to Float.asString:
%% FIXME:
%% FIXME: \begin{urbiscript}
%% FIXME: 42.asString(16);
%% FIXME: [00000001] "2a"
%% FIXME: // Float.hex is a shortcut:
%% FIXME: 42.hex;
%% FIXME: [00000001] "2a"
