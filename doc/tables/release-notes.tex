...
\item \lstinline|Semaphore.acquire| and \lstinline|Semaphore.release| are
  promoted over \lstinline|Semaphore.p| and \lstinline|Semaphore.v|.
\end{itemize}
...
\item["System.searchPath" method]
  ...
  or \file{URBI.INI} by using \lstinline|System.searchPath|.
