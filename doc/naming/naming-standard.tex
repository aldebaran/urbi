...
This document aims at clarifying the naming conventions in \urbi
...
\code{body neck} &
\code{camera mouth ear lip eye eyebrow} &
\code{{}-} \\\hline
mouth &
...
touch &
Touch sensor. &
\code{finger grip foot toe} &
\code{{}-} &
\code{touchSensor} \\\hline
gyro &
Gyrometer sensor. &
\code{body} &
\code{{}-} &
\code{gyroSensor} \\\hline
accel  &
Accelerometer sensor. &
\code{body} &
\code{{}-} &
\code{accelerationSensor} \\\hline
camera &
...
\code{robot} &
\code{{}-} &
\code{speechRecognizer} \\\hline
voice &
Voice synthesis component. &
\code{robot} &
\code{{}-} &
\code{textToSpeech} \\\hline
\end{supertabular}
\end{center}
