...
\section[Introduction]{\selectlanguage{english} Introduction}
...
\hhline{-~}
 &
\selectlanguage{english}\sffamily Optional slot.\\\hhline{-~}
\end{supertabular}
\end{flushleft}
{\selectlanguage{english}\sffamily\bfseries\itshape
...
\selectlanguage{english} \textsf{The shutter speed }\textsf{(expressed
in ms). 0 if non applicable.}\\\hline
\selectlanguage{english} wb &
\selectlanguage{english} \textsf{White balance }\textsf{(expressed with
an integer value depending on the camera documentation). 0 if non
applicable.}\\\hline
\selectlanguage{english} gain &
\selectlanguage{english} \textsf{Camera gain amplification
...
\hhline{-~}
 &
\selectlanguage{english} Optional slot.\\\hhline{-~}
\end{supertabular}
\end{flushleft}
{\selectlanguage{english}\sffamily\bfseries\itshape
audioout}
...
\selectlanguage{english} \textsf{The amount of time remaining to play in
...
\selectlanguage{english} \textsf{The content is the sound heard by the
microphone since the last }update\textsf{ event.}\\\hline
\selectlanguage{english} duration &
\selectlanguage{english} \textsf{Amount of sound in the }val\textsf{
attribute, expressed in }\textsf{\textit{ms}}\textsf{.}\\\hline
\selectlanguage{english} gain &
\selectlanguage{english} \textsf{Microphone gain amplification
...
\selectlanguage{english} \textsf{A boolean expressing whether there is a
blob in the image or not (see }threshold\textsf{)}\\\hline
\selectlanguage{english} threshold &
\selectlanguage{english} \textsf{The minimum value of }ratio\textsf{ to
...
\selectlanguage{english}\sffamily Speaker device. If several speakers
...
\selectlanguage{english}\sffamily Microphone devices. If several
