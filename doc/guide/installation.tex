...
\item[\var{version}] specifies the exact revision of Urbi that you are
  ...
  \item[beta3] designates the third priceless,
...
\item[\var{compiler}] is the tool chain used to compile the
  programs: \code{gcc} for the GNU Compiler Collection, \code{vcxx}
...
Decompress the package where you want to install it.  The package is
