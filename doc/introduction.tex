...
%%
%% \paragraph{Authors}
%% \usdk 1 was further developped by Akim Demaille, Guillaume Deslandes,
%% Quentin Hocquet, and Benoît Sigoure.
%%
%% The \usdk 2 project was started and developped by Akim Demaille, Quentin
