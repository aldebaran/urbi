...
\begin{urbiscript}[caption=Inspecting an \urbi
...
\begin{urbiscript}[caption=Defining slots with var, label=lst:setslot-var]
...
\begin{urbiscript}[caption=Manipulating existent slot is an error,
...
\begin{urbiscript}[caption=Checking the prototype, label=lst:proto-check]
...
\begin{urbiscript}[caption=Defining constructors, label=lst:define-ctor]
do MyPair
{
  function init(f, s)
  {
...
\begin{urbiscript}[caption=Lambda function, label=lst:lambda]
