...
encounter problems, please see \autoref{sec:installation}, which provides
detailed installation instructions, and possibly \autoref{sec:faq} for
...
Then, the interaction proceeds in the \command{urbi-console} windows.
Specify the host name and port to use (\samp{127.0.0.1:54000}) in the text
field in the top of the window.
